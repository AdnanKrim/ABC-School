...
<NavLink to="/defaultPanel/adminStudentInformation">
              <li className="font-semibold text-lg mb-3">
                <span className="rounded-r-full bg-[#191c24] p-2 border-l-4 border-blue-500"><IoIosSpeedometer className="text-blue-500" size={20} /> Student Information</span>
              </li>
</NavLink>
