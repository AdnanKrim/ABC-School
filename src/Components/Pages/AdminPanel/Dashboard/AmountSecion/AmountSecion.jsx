...
const AmountSecion = () => {
  return (
    <div>
      ...
      {/* Total Amount Debit */}
 <div className="flex items-center border-t-2 border-yellow-500 shadow-lg shadow-yellow-500 bg-black rounded-xl lg:px-7 lg:py-10 md:px-7 md:py-5 sm: px-16 py-10 mb-5">
        <div>
